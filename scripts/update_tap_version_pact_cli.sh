    ...
    write_homebrew_formulae() {
        if [ ! -f "$FORMULAE_FILE" ] ; then
         ...
         exec 3<> $FORMULAE_FILE
            ...
            echo "  homepage \"https://github.com/YOU54F/pact-cli\"" >&3
            echo "  url \"https://github.com/YOU54F/pact-cli.git\"" >&3
            echo "  license \"MIT\"" >&3
            echo "" >&3
            echo "  livecheck do" >&3
            echo "    url :stable" >&3
            ...
            echo "" >&3
            echo "  head do" >&3
            echo "    url \"https://github.com/YOU54F/pact-cli.git\", branch: \"main\"" >&3
            echo "    depends_on \"rust\" => :build" >&3
            echo "  end" >&3
            echo "" >&3
            echo "  on_macos do" >&3
            echo "    on_intel do" >&3
            echo "      url \"https://github.com/YOU54F/pact-cli/releases/download/$filename_macos_x64\"" >&3
            echo "      sha256 \"${sha_macos_x86_64}\"" >&3
            echo "    end" >&3
            echo "" >&3
            echo "    on_arm do" >&3
            echo "      url \"https://github.com/YOU54F/pact-cli/releases/download/$filename_macos_arm\"" >&3
            ...
            echo "  on_linux do" >&3
            echo "    on_intel do" >&3
            echo "      url \"https://github.com/YOU54F/pact-cli/releases/download/$filename_linux_x64\"" >&3
            echo "      sha256 \"${sha_linux_x86_64}\"" >&3
            echo "    end" >&3
            echo "" >&3
            echo "    on_arm do" >&3
            echo "      url \"https://github.com/YOU54F/pact-cli/releases/download/$filename_linux_arm\"" >&3
