class PactVerifierCli030 < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/pact-foundation/pact-reference/releases/download/pact_verifier_cli-v0.3.0/pact_verifier_cli-linux-x86_64.gz"
