class PactMockServerCli078 < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/pact-foundation/pact-reference/releases/download/pact_mock_server_cli-v0.7.8/pact_mock_server_cli-osx-x86_64.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/pact-foundation/pact-reference/releases/download/pact_mock_server_cli-v0.7.8/pact_mock_server_cli-linux-aarch64.gz"
      sha256 "7799ee2f056f3bfb6eb3c5227716c03eade28d6f5ddda68cf2000956cfbc81c6"
    end
    on_intel do
      url "https://github.com/pact-foundation/pact-reference/releases/download/pact_mock_server_cli-v0.7.8/pact_mock_server_cli-linux-x86_64.gz"
