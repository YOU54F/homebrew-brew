class Pact < Formula
  ...
  url "https://github.com/YOU54F/pact-cli.git"
  license "MIT"
  ...
  head do
    url "https://github.com/YOU54F/pact-cli.git", branch: "main"
    depends_on "rust" => :build
  end

  on_macos do
    on_intel do
      url "https://github.com/YOU54F/pact-cli/releases/download/v0.9.0/pact-x86_64-macos"
      sha256 "adf97e86f65f317b94d4568eb9d11f42642eead2f4a6fecd39b9cbe23962abf4"
    end

    on_arm do
      url "https://github.com/YOU54F/pact-cli/releases/download/v0.9.0/pact-aarch64-macos"
      sha256 "e89c42437e9bf4714872a99e4dcb9c937d0f968fa2cc921ac1fa0dfacf2e9931"
    end
  end

  on_linux do
    on_intel do
      url "https://github.com/YOU54F/pact-cli/releases/download/v0.9.0/pact-x86_64-linux-musl"
      sha256 "8072b7eb1768335f04ea21b05022da251a175243a075fc426973dd686347bfbc"
    end

    on_arm do
      url "https://github.com/YOU54F/pact-cli/releases/download/v0.9.0/pact-aarch64-linux-musl"
      sha256 "40fb74c4551af0ae25f1c5f05e39335ae8b5e3b97269f510ab0051e3b4f761a2"
    end
  end
